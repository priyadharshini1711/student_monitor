						...
						<div class="row gtr-150">
							<div class="col-8 col-12-medium">
								...
								<!-- Content -->
									...
									$sql= "SELECT * FROM  `univ` WHERE  `regno` LIKE  '".$var_name."' LIMIT 0 , 30";
									...
									print "<tr><td>IP</td><td>" .$row[2] . "</td></tr>"; 
									print "<tr><td>OOAD</td><td>" .$row[3] . "</td></tr>"; 
									print "<tr><td>TOC</td><td>" .$row[4] . "</td></tr>"; 
									print "<tr><td>CG</td><td>" .$row[5] . "</td></tr>"; 
									print "<tr><td>CTLAB</td><td>" .$row[6] . "</td></tr>"; 
									print "<tr><td>IPLAB</td><td>" .$row[7] . "</td></tr>"; 
									print "<tr><td>CGLAB</td><td>" .$row[8] . "</td></tr>"; 
									print "<tr><td>DM </td><td>" .$row[9] . "</td></tr>"; 							
									} 
									print "</table>"; 
									?>
   								</section>
