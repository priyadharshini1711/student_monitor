...
<form id="form" class="topBefore" action="class.php" method="post">
		
		  <input id="id" type="text" placeholder="ID" name="id" ><br/><br/>
		  <input id="name" type="text" placeholder="NAME" name="name"><br/><br/>
		  <textarea id="message" type="text" placeholder="MESSAGE" name="message"></textarea><br/><br/>
