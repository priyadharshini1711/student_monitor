		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
						<header class="major">
							<h2>STAFF PAGE - PERSONAL INFO</h2>
						...
						<div class="row gtr-150">
							...
							<div class="col-8 col-12-medium imp-medium">
								...
								<!-- Content -->
									...
									<?php
									session_start();
									$var_name = $_SESSION['sess_user'];
									$con = mysqli_connect("localhost", "root", "", "student");
									$sql= "SELECT * FROM `staffuser` WHERE  `uname` LIKE  '".$var_name."' LIMIT 0 , 30";
									$result = mysqli_query($con, $sql);
									print "<table>";
									while($row = mysqli_fetch_row($result))
									{
									print "<tr><td>NAME</td><td>" .$row[0] . "</td></tr>"; 
									print "<tr><td>ID</td><td>" .$row[1] . "</td></tr>"; 								
									} 
									print "</table>"; 
									?>
									</section>
