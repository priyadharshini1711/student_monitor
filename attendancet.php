						...
						<div class="row gtr-150">
							<div class="col-8 col-12-medium">
								...
								<!-- Content -->
									...
									$sql= "SELECT * FROM  `attendance` WHERE  `regno` LIKE  '".$var_name."' LIMIT 0 , 30";
									...
									print "<tr><td>TOTAL DS</td><td>" .$row[3] . "</td></tr>"; 
									print "<tr><td>ATTENDED DS</td><td>" .$row[4] . "</td></tr>"; 
									print "<tr><td>PERCENTAGE DS</td><td>" .$row[5] . "</td></tr>"; 
									print "<tr><td>TOTAL AI</td><td>" .$row[6] . "</td></tr>"; 
									print "<tr><td>ATTENDED AI</td><td>" .$row[7] . "</td></tr>"; 
									print "<tr><td>PERCENTAGE AI</td><td>" .$row[8] . "</td></tr>"; 
									print "<tr><td>TOTAL CD</td><td>" .$row[9] . "</td></tr>"; 
									print "<tr><td>ATTENDED CD</td><td>" .$row[10] . "</td></tr>"; 
									print "<tr><td>PERCENTAGE CD</td><td>" .$row[11] . "</td></tr>"; 
									print "<tr><td>TOTAL MC</td><td>" .$row[12] . "</td></tr>"; 
									print "<tr><td>ATTENDED MC</td><td>" .$row[13] . "</td></tr>"; 
									print "<tr><td>PERCENTAGE MC</td><td>" .$row[14] . "</td></tr>"; 
									print "<tr><td>TOTAL DSP</td><td>" .$row[15] . "</td></tr>"; 
									print "<tr><td>ATTENDED DSP</td><td>" .$row[16] . "</td></tr>"; 
									print "<tr><td>PERCENTAGE DSP</td><td>" .$row[17] . "</td></tr>"; 
									print "<tr><td>TOTAL TQM</td><td>" .$row[18] . "</td></tr>"; 
									print "<tr><td>ATTENDED TQM</td><td>" .$row[19] . "</td></tr>"; 
									print "<tr><td>PERCENTAGE TQM</td><td>" .$row[20] . "</td></tr>"; 									
									} 
									print "</table>"; 
									?>
   								</section>
