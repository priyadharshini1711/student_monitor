...
<html>
	<head>
		<title>STUDENT PAGE - CO-CURRICULARS</title>
		<meta charset="utf-8" />
		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<div id="main" class="wrapper style1">
					<div class="container">
						<header class="major">
							<h2>STUDENT PAGE - CO CURRICULAR</h2>
						...
						<div class="row gtr-150">
							<div class="col-8 col-12-medium">
								...
								<!-- Content -->
									...
									$sql= "SELECT * FROM  `ccs` WHERE  `regno` LIKE  '".$var_name."' LIMIT 0 , 30";
									...
									print "<tr><td>DATE</td><td>" .$row[1] . "</td></tr>"; 
									print "<tr><td>NAME</td><td>" .$row[2] . "</td></tr>"; 
									print "<tr><td>YEAR/SEC</td><td>" .$row[3] . "</td></tr>"; 
									print "<tr><td>COLLEGE</td><td>" .$row[4] . "</td></tr>"; 
									print "<tr><td>WORKSHOP</td><td>" .$row[5] . "</td></tr>"; 
									print "<tr><td>PRIZE</td><td>" .$row[6] . "</td></tr>"; 
									print "<tr><td>AMOUNT</td><td>" .$row[7] . "</td></tr>"; 
									print "<tr><td>TOTAL NO OF STUDENTS</td><td>" .$row[8] . "</td></tr>"; 						
									} 
									print "</table>"; 
									if($set===0)
									echo "<font size=\"30px\">NO RECORD FOUND</font>"
									?>
   								</section>
