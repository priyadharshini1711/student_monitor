...
if (isset($_POST["import"])) 
{
    ...
    if ($_FILES["file"]["size"] > 0 and $set==0) 
	{
        ...
        while (($column = fgetcsv($file, 10000, ","))!== FALSE )
		{
		 ...
		 {
$sqlInsert = "INSERT into univ values ('".$column[0]."','".$column[1]."','".$column[2]."','".$column[3]."','".$column[4]."','".$column[5]."','".$column[6]."','".$column[7]."','".$column[8]."','".$column[9]."')";
