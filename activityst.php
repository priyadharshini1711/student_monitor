						...
						<div class="row gtr-150">
							<div class="col-8 col-12-medium">
								...
								<!-- Content -->
									...
									$sql= "SELECT * FROM  `cls` WHERE  `regno` LIKE  '".$var_name."' LIMIT 0 , 30";
									...
									{
									$set = 1;
									print "<tr><td>ID</td><td>" .$row[0] . "</td></tr>"; 
									print "<tr><td>NAME</td><td>" .$row[1] . "</td></tr>"; 
									print "<tr><td>MESSAGE</td><td>" .$row[2] . "</td></tr>"; 				
									} 
									print "</table>"; 
									if($set===0)
